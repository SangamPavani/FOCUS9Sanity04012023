	...
	/*public static boolean checkVoucherSavingMessage(String docno) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
{
	...
	public static boolean checkOpeningBalanceCustomizationRemovingLinkStatusColumn() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		...
		String expHeaderListBeforeDelete = "[, , #, Date, Voucher Number, Created by, Modified By, Created Date, Modified Date, Created time, Modified Time, Suspended, Authorization Status, Balance link value, Link status]";
		...
		String expHeaderListAfterDelete = "[, , #, Date, Voucher Number, Created by, Modified By, Created Date, Modified Date, Created time, Modified Time, Suspended, Authorization Status, Balance link value]";
	...
	public static boolean checkOpeningBalanceCustomizationHideBalanceLinkValueColumn() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		...
		for (int i = 0; i < custBodyHeaderListCount; i++)
		{
			...
			if (data.equalsIgnoreCase("Balance link value")) 
			{
				custBodyHeaderList.get(i).click();

				Thread.sleep(2000);

				if (hideThisColumnChkbox.isSelected()==false) 
				{
		...
		String expHeaderListAfterHiding = "[, , #, Date, Voucher Number, Created by, Modified By, Created Date, Modified Date, Created time, Modified Time, Suspended, Authorization Status]";
		...
		String expHeaderListAfterUnHiding = "[, , #, Date, Voucher Number, Created by, Modified By, Created Date, Modified Date, Created time, Modified Time, Suspended, Authorization Status]";
	...
	public static boolean checkOpeningBalanceCustomizationAddingDepartmentColumn() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		...
		String expHeaderListAfterAdding = "[, , #, Date, Voucher Number, Created by, Modified By, Created Date, Modified Date, Created time, Modified Time, Suspended, Authorization Status, Department Name]";
