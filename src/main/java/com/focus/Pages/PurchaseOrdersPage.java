...
*/
	...
	private static WebElement  insertRowBtn1;
...
public static WebElement searchOrderTxt;
	...
	public static boolean checkSavingPurchasesOrderVoucher2WithTwoRows() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		...
		/*for (int i = 0; i < pvvGridItemListCount; i++) 
		{
			...
			if (Item.equalsIgnoreCase("STD RATE COGS ITEM")) 
			{
				getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(searchOrderTxt));
				searchOrderTxt.sendKeys("STD RATE COGS ITEM");
				pvvGridItemList.get(i).click();
				break;
			}
		}*/
...
*/
	...
	@FindBy (xpath="//ul[@id='id_transaction_viewcontainer']/li[3]/a")
	...
	public static boolean checkDataInPurchaseVoucherVATVoucher1ConvertedLink() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		...
		String expR2LPurchase = "PurOrd:2";
	...
	private static List<WebElement> LPurchaseOrderPopupList;

	@FindBy (xpath="//tbody[@id='id_transaction_entry_detail_workflow_popup_body']/tr/td[7]")
	private static List<WebElement> LPurchaseOrderPopupVoucherNos;

	@FindBy (xpath="//tbody[@id='id_transaction_entry_detail_workflow_popup_body']/tr/td[2]/input")
	private static List<WebElement> LPurchaseOrderPopupCheckBoxs;

	@FindBy (xpath="//*[@id='id_transaction_workflow_popup_heading']/div/ul/li[3]/div")
	private static WebElement LPurchaseOrderPopupOkBtn;

	@FindBy (xpath="//i[@id='id_transactionentry_workflow_popup_close']")
	private static WebElement LPurchaseOrderPopupCloseBtn;


	@FindBy (xpath="//*[@id='id_transaction_entry_detail_workflow_popup_body']/tr[1]/td[11]")
	private static WebElement LpurchaseOrderPopupRow1SuspendCol;

	@FindBy (xpath="//*[@id='id_transaction_entry_detail_workflow_popup_body']/tr[2]/td[11]")
	private static WebElement LpurchaseOrderPopupRow2SuspendCol;
	...
	public static boolean checkSavingPurchaseVoucherVATVoucher1WithPurchaseOrderLink() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		...
		String expRow1PurOrdList = "[1, PurOrd:1, STD RATE COGS ITEM, 24.00, 2, PurOrd:2, STD RATE COGS ITEM, 24.00]";
		...
		String expRow1LPurOrd = "PurOrd:2";



		System.out.println("*****************"+actRow1LPurOrd);
		System.out.println("*****************"+expRow1LPurOrd);
		...
		String expRow2PurOrdList = "[1, PurOrd:1, STD RATE COGS ITEM, 24.00, 2, PurOrd:2, STD RATE COGS ITEM, 12.00]";
		...
		String expRow2LPurOrd = "PurOrd:2";
		...
		String expRow3PurOrdList = "[1, PurOrd:1, STD RATE COGS ITEM, 24.00]";
		...
		String actRow3LPurOrd = select3rdRow_10thColumn.getText();
		String expRow3LPurOrd = "";
...
*/
	...
	public static boolean checkLPurchaseOrderPopupInPurchaseVoucherVATVoucher2() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		...
		String expPurOrdList = "[1, PurOrd:1, STD RATE COGS ITEM, 24.00, 2, PurOrd:2, STD RATE COGS ITEM, 12.00]";
		...
		String expMessage = "VoucherNo - SU/IND/TEXT1: Voucher deleted Successfully";
	...
	@FindBy (xpath="//tbody[@id='tblBodyTransRender']/tr[1]/td[12]")
	private static WebElement voucherHomeRow1SuspendedStatus;
	
	public static boolean checkSuspendingMaterialRequisitionVoucher2FromEntryPage() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(inventoryMenu));
		inventoryMenu.click();
...
String expMessage1 = "Voucher saved successfully";
	...
	/////////////////////////////////////////
	 ...
	 @FindBy(xpath="//a[@id='2560']")
		private static WebElement  purchaseOrderBtn;
	 
	  @FindBy(xpath="//*[@id='17_1_AdvanceFilter_']/table/tbody/tr/td[1]/select")
	  private static WebElement editLayoutTriggerValue;  
	  
	  @FindBy(xpath="//ul[@class='treeview col-xs-12']//a[@id='23']//span[@class='icon-right-arrow']")
	...
	public boolean checkSavingTriggerwithRaiseDocumentOptioninPurchaseOrders() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	   {
		   ...
		   getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(purchaseOrderBtn));
		   ...
		   getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(editLayoutTriggerName));
			...
			editLayoutTriggerName.sendKeys("PurchaseOrderTrigger");
	       ...
	       Thread.sleep(2000);		
			...
			triggersValueToEnterTxt.sendKeys("STD RATE COGS ITEM");	
			...
			getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(selectRaiseaDocument));
			selectRaiseaDocument.click();
			
			Select s=new Select(selectRaiseaDocument);
			//s.selectByVisibleText("Purchases Vouchers");
			s.selectByValue("769");
			Thread.sleep(2000);
			//selectRaiseaDocument.sendKeys(Keys.TAB);
		...
		private static WebElement  voucherSaveBtn;
	   */
	   public static boolean checkSavingPurchasesOrderVoucher1() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
		{
		   Thread.sleep(2000);
		...
		public boolean checkSavedPurchaseVoucherVAT1AfterSavingPurchaseOrder() throws EncryptedDocumentException, InvalidFormatException, InterruptedException, IOException
		{
			...
			getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(voucherHomeBody1stRow12thCol));
			String actSuspendStatus=voucherHomeBody1stRow12thCol.getText();
			String expSuspendStatus="True";
			...
			System.out.println("*******************************checkSavedPurchaseVoucherVATVoucher1**********************************");
			...
			if( actSuspendStatus.equalsIgnoreCase(expSuspendStatus)&&actItem.equalsIgnoreCase(expItem)  
		...
		@FindBy (xpath="//tbody[@id='tblBodyTransRender']/tr[1]/td[12]")
		private static WebElement voucherHomeBody1stRow12thCol;
		...
		*/
		...
		public boolean checkDeletingVoucher1PurchaseOrder() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
		{
			getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(inventoryMenu));
			inventoryMenu.click();
	...
	public boolean checkPurchaseVoucherVAtVoucherAfterDeletingPurchaseOrders()
	{
		boolean actData=voucherHomeBodyList.isEmpty();
