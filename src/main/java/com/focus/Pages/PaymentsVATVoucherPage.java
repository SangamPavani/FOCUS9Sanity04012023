...
*/
	...
	@FindBy(xpath="//li[@id='id_Pick']")
	private static WebElement  billRefPickIcon;		

	@FindBy(xpath="//li[@id='id_Ok']")
	...
	public static boolean checkSavingPaymentVATVoucher1() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		...
		String expbalOnAdjstDateAmtPick                 ="4.10";
...
*/
	...
	public static boolean checkEditingPaymentVATVoucher1AndAdding2ndRow() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		...
		String expReference = "NDT57:SU/IND/TEXT1";
...
*/
	...
	public static boolean checkVerifyingSavedPaymentVATVoucher2() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		getWebDriverWait().until(ExpectedConditions.elementToBeClickable(previousBtn));
		previousBtn.click();
		...
		String actReference = select1stRow_4thColumn.getText();
		String expReference = "New Reference";
	...
	public static WebElement close1Btn;
	
	public boolean checkBillwsieScreenByClickingOnReferneceColInEntryPage() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		...
		String actNewReferenceTxt=newReferenceTxt.getText();
		String expNewReferenceTxt="30.00";
		if(actNewReferenceTxt.equalsIgnoreCase(expNewReferenceTxt))
		{
			return true;
		}
		else
		...
		} catch (Exception e) 
		{
			...
			getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(close1Btn));
			close1Btn.click();
			return false;
	...
	public boolean checkDeletionofPaymentsVATVouvher2() throws EncryptedDocumentException, InvalidFormatException, InterruptedException, IOException
	{
