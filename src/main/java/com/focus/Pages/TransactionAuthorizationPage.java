	...
	//Currency Menu
		...
		private static WebElement  ISOCurrencyCodeSettingsBtn;
		 ...
		 public boolean checkSavingTransactionAuthorizationInPurchaseReturns() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	     {
	    	...
	    	public static WebElement financilasMenu;
	    	
	    	@FindBy(xpath="//*[@id='2009']/span")
	    	public static WebElement purchaseReturns;
	    	
	    	@FindBy(xpath="//*[@id='id_transaction_homescreen_new']/div[1]/span")
	    	public static  WebElement purchaseReturnsNewBtn;
	    	...
	    	public static WebElement purchaseReturnssaveBtn;
	    	...
	    	public static WebElement voucherCloseBtn;
	    	
	    	
	    	
	    	public boolean checkPurchaseReturnsVoucher1() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException{
	    	
	    		Thread.sleep(1000);
	    		getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(financilasMenu));
	    		financilasMenu.click();
	    		...
	    		getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(purchaseReturns));
	    		purchaseReturns.click();
	    		
	    		//Thread.sleep(1000);
	    		getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(purchaseReturnsNewBtn));
	    		purchaseReturnsNewBtn.click();
	    		Thread.sleep(2000);
	    		...
	    		getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(purchaseReturnssaveBtn));
	    		purchaseReturnssaveBtn.click();
	    		...
	    		expMessage.add("Voucher saved successfully ");
	    		...
	    		public static WebElement statusVoucher1;
	    		
	    		public  boolean checkAuthorizationStatusOfVoucher1(){
	    			String status="";
	    			getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(financilasMenu));
		    		financilasMenu.click();
		    		...
		    		for(int i=0;i<size;i++){
		    			String data=vouchersList.get(i).getText();
		    			System.err.println(data);
		    			
		    			if(data.equalsIgnoreCase("1")){
		    				status=statusList.get(i).getText();
		    				System.err.println(status);
		    			}
		    		}
		    		
	    			String actStatus=status;
	    			
	    			//String actStatus=statusVoucher1.getText();
	    			String expStatus="Pending";
	    			System.out.println("Actual Status"+actStatus);
	    		...
	    		public boolean checkPurchaseReturnsVoucher2() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException{
		    		...
		    		public static WebElement statusVoucher2;
		    		
		    		@FindBy(xpath="//*[@id='tblBodyTransRender']//td[5]")
		    		public static List<WebElement> vouchersList;
		    		
		    		@FindBy(xpath="//*[@id='tblBodyTransRender']//td[13]")
		    		public static List<WebElement> statusList;
		    		
		    		
		    		
		    		@FindBy(xpath="//*[@id='id_transaction_homescreen_Delete']/div[1]/span")
		    		public static WebElement homeDeleteBtn;
		    		
		    		public  boolean checkAuthorizationStatusOfVoucher2(){
		    			String status="";
		    		...
		    		@FindBy(xpath="//*[@id='tblBodyTransRender']//td[2]")
		    		public static List<WebElement> voucherChkbox;
			    		
		    		public static boolean checkVerifyingAndDeletingPurchaseReturnsVoucher1() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
		    		{
		    			Thread.sleep(2000);
		    			/*getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(financilasMenu));
			    		financilasMenu.click();
		    			...
		    			*/
			    		...
			    		for(int i=0;i<size;i++){
			    			...
			    			System.err.println(data);
			    			if(data.equalsIgnoreCase("1")){
			    				//voucherChkbox.get(i).click();
			    				getAction().click(voucherChkbox.get(i)).build().perform();
			    				//click(voucherChkbox);
			    				break;
			    			}
			    		}
			    	...
			    	/*	int count = grid_VoucherNoList.size();
			    		...
			    		//voucherChkbox.click();
		    			getWebDriverWait().until(ExpectedConditions.elementToBeClickable(homeDeleteBtn));
		    			homeDeleteBtn.click();
		    		...
		    		public static boolean checkVerifyingAndDeletingPurchaseReturnsVoucher2() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
		    		{
		    			Thread.sleep(2000);
