...
private static List<WebElement> masterItemsList;
	...
	//Currency Menu
		...
		private static WebElement priceBookExportToExcel;
		...
		public boolean checkExportingBuyerPriceBook() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException, AWTException
		{
			...
			System.err.println("No of tabs : "+actOpenWindowsCount);
		 	...
		 	Workbook Exportedfile=new XSSFWorkbook(getBaseDir()+"\\autoIt\\ExportFiles\\TestSmokeBuyigRates.xlsx");
		...
		@FindBy(xpath="//button[@id='btnAdvExcelImport']")
		...
		private static WebElement sheetStartDateHeading;
		...
		private static WebElement sheetEndDateHeading;
		
		@FindBy(xpath="//select[@id='ddlImportFromExcelItemList5']")
		private static WebElement sheetEndDate;
		...
		private static WebElement sheetPTHeading;
		
		@FindBy(xpath="//select[@id='ddlImportFromExcelItemList11']")
		private static WebElement sheetPT;
		...
		private static List<WebElement> buyerPriceBook_CustomizeCheckBoxList;
		
		@FindBy (xpath="//tbody[@id='PriceBookWebGrid_body']/tr[1]/td")
		private static List<WebElement> buyerPriceBook_TableRow1List;
		
		@FindBy (xpath="//tbody[@id='PriceBookWebGrid_body']/tr[2]/td")
		private static List<WebElement> buyerPriceBook_TableRow2List;
		
		
		@FindBy(xpath="//select[@id='ImportGrid_ExternalFields']")
		private static WebElement buyerPriceBook_MappingDrpdwn;
		...
		public boolean checkImportingBuyerPriceBook() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException, AWTException
		{
			...
			String expPriceBookRow1 ="[1, ITEMS GROUP, , AMERICA, "+presentDate+", "+endDate+", , Indian Rupees, 0, 0, , 200.000000, 100.000000, 50.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, , , , Authorized, ]";
		...
		@FindBy(xpath="//button[@id='btnSheetOkAID']")
		...
		@FindBy(xpath="//*[@id='AdvanceImportModalDiv']//div[3]/div/span[1]")
		...
		@FindBy(xpath="//*[@class='icon-newdocument icon-font6']")
		private static WebElement PRHNewLayoutBtn;
		
		@FindBy(xpath="//*[@id='forHf']/span[1]/span")
		...
		@FindBy(xpath="//*[@id='forHf']/span[3]/span")
	...
	////
		...
		Runtime.getRuntime().exec(getBaseDir()+"\\autoIt\\scripts\\PrintRateHistory.exe");
	...
	@FindBy(xpath="//*[@id='myModal2']//div[3]/button")			 
	...
	public boolean checkViewPriceCustomizationBtnBuyerPriceBook() throws InterruptedException
	{
		...
		String expHeaderListAfterCust ="[Pricebook Name, Item Code, Item Name, Currency, Min Qty, Max Qty, Unit, Rate, Start Date, End Date, ModifiedBy, Created by, , ]";
	...
	public boolean checkViewPriceBuyerPriceBook() throws InterruptedException 
	{
		...
		String actPriceBookRow1 = pricebookRow1List.toString();
		String expPriceBookRow1 ="[TestSmokeBuyigRatesAdvExcelImport, BR COGS ITEM, BR COGS ITEM, Indian Rupees, 0, 0, Dozs, 300.000000, "+presentDate+", "+endDate+"]";
		...
		String actPriceBookRow2 = pricebookRow2List.toString();
		String expPriceBookRow2 ="[TestSmokeBuyigRatesImport, BR COGS ITEM, BR COGS ITEM, Indian Rupees, 0, 0, Dozs, 300.000000, "+presentDate+"]";
	...
	@FindBy(xpath="(//*[@id='btnExporttoExcel'])[1]")
	...
	////////////////////////////////////////////////////////////////////////////////////////////////
		...
		public boolean checkExportingBuyerPriceBookExcel() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException, AWTException
		{

			File Efile=new File(getBaseDir()+"\\autoIt\\ExportFiles\\TestSmokeBuyigRatesExcel.xlsx");
			...
			getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(buyerPriceBook_PriceBook));
			buyerPriceBook_PriceBook.sendKeys("TestSmokeBuyigRatesExcel");
			Thread.sleep(1000);
			buyerPriceBook_PriceBook.sendKeys(Keys.TAB);
			...
			System.err.println("No of tabs : "+actOpenWindowsCount);
		 	...
		 	Workbook OrginalFile = new XSSFWorkbook(getBaseDir()+"\\autoIt\\ImportFiles\\TestSmokeBuyigRatesExcel.xlsx");
		 	Workbook Exportedfile=new XSSFWorkbook(getBaseDir()+"\\autoIt\\ExportFiles\\TestSmokeBuyigRatesExcel.xlsx");
		...
		public boolean checkAddingExtraRowinExportedFile() throws EncryptedDocumentException, InvalidFormatException, IOException
		{
			ExcelReader excelReader = new ExcelReader(POJOUtility.getExcelPath());
			
			String actExcelfile = getBaseDir()+"\\autoIt\\ExportFiles\\TestSmokeBuyigRatesExcel.xlsx";
			//String expExcelfile = getBaseDir()+"\\autoIt\\ImportFiles\\spb1.xlsx";
			//String sheet = "PriceBook";
			...
			Workbook workbook1  = WorkbookFactory.create(fip1);
			  ...
			  Sheet sheet1 = workbook1.getSheetAt(0);
			    ...
			    sheet1.shiftRows(1, sheet1.getLastRowNum()+1, 1, true,true);
			    row.createCell(0).setCellValue("STD RATE COGS ITEM");
			    row.createCell(1).setCellValue("STD RATE COGS ITEM");
			    row.createCell(3).setCellValue("AMERICA");
			    row.createCell(4).setCellValue("Indian Rupees");
			    row.createCell(5).setCellValue("09/10/2020");
			    row.createCell(7).setCellValue("0");
			    row.createCell(8).setCellValue("0");
			    row.createCell(9).setCellValue("Dozs");
			    row.createCell(10).setCellValue("200.000000");
			    row.createCell(11).setCellValue("100.000000");
			    row.createCell(12).setCellValue("50.000000");

			    // Write the output to a file
			    FileOutputStream fileOut = new FileOutputStream(getBaseDir()+"\\autoIt\\ExportFiles\\TestSmokeBuyigRatesExcel.xlsx");
			...
			excelReader.setCellData(actExcelfile, sheet, 3, 0,"STD RATE COGS ITEM" );
			excelReader.setCellData(actExcelfile, sheet, 3, 1, "STD RATE COGS ITEM");
			excelReader.setCellData(actExcelfile, sheet, 3, 3, "AMERICA");
			excelReader.setCellData(actExcelfile, sheet, 3, 3, "Indian Rupees");
			excelReader.setCellData(actExcelfile, sheet, 4, 5, "09/10/2020");
			excelReader.setCellData(actExcelfile, sheet, 3, 7, "0");
			excelReader.setCellData(actExcelfile, sheet, 3, 8, "0");
			excelReader.setCellData(actExcelfile, sheet, 3, 9, "Dozs");
			excelReader.setCellData(actExcelfile, sheet, 3, 10, "200.000000");
			excelReader.setCellData(actExcelfile, sheet, 3, 11, "100.000000");
			excelReader.setCellData(actExcelfile, sheet, 3, 12, "50.000000");
*/			return true;

		}
		
		public boolean checkImportingAppendExcelBuyerPriceBook() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
		{
		ExcelReader excelReader = new ExcelReader(POJOUtility.getExcelPath());
		
		String excelfile = getBaseDir()+"\\autoIt\\ImportFiles\\TestSmokeBuyigRatesImportExcel.xlsx";
		String sheet = "PriceBook";
		...
		buyerPriceBook_PriceBook.sendKeys(Keys.SHIFT,Keys.HOME);
		Thread.sleep(2000);
		buyerPriceBook_PriceBook.sendKeys("TestSmokeBuyigRatesImportExcel");
		Thread.sleep(2000);
		buyerPriceBook_PriceBook.sendKeys(Keys.TAB);
		...
		Runtime.getRuntime().exec(getBaseDir()+"\\autoIt\\scripts\\FocusBuyerImportPriceAppend.exe");
		...
		getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(buyerPriceBook_MappingDrpdwn));
		Select pricebook = new Select(buyerPriceBook_MappingDrpdwn);
		pricebook.selectByVisibleText("TestSmokeBuyigRatesImportExcel");
