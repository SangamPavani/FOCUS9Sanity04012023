...
public class Focus10InventoryReportsPage extends BaseEngine
{
	...
	public boolean checkLoginTOAutomationCompany() throws InterruptedException
	{
		...
		String compname="Automation Company : 08/10/2020(010)";

		 Select oSelect = new Select(companyDropDownList);
		 oSelect.selectByValue("72");
	...
	public boolean checkItemQueryReport() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		...
		String exppurTotalWa		="NDT57:SU/IND/TEXT2";//NDT57:SU/IND/TEXT2
		...
		String expsalQtyInBaseR1	="10.0000000000";
		...
		String expsalQtyInBaseR2	="12.0000000000";
		...
		String exprateR1			="0.69";
		String expvalueR1			="42.75";
		
		String exptotalStock		="62.00";
		String exptotalValue		="42.75";
	...
	*/	
	...
	// Stock Ledger Elements 
			...
			@FindBy(xpath="//*[@id='id_mainreportmenuheadings']/ul/li[7]")
			private static WebElement sl_OkBtn;
			
			@FindBy(xpath="//*[@id='id_mainreportmenuheadings']/ul/li[8]")
			...
			public boolean checkStockLedgerReport() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
			{
				...
				String actRow3List = reportsRow3ListArray.toString();
				String expRow3List = "[23/11/2021, NDT57:SU/IND/TEXT5, 12.00, 10.50, , , 36.00, 126.00, , 210.00, 5.83, , , ]";
				*/						
			...
			public boolean checkStockLedgerCustomizationReport() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
			{
				...
				System.out.println("actual"+actMessage);
...
*/
			...
			public boolean checkOpeningStockRegisterReportBackTrackOption() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
			{
				...
				String expExpiryDate="28/11/2021";
				...
				String expExpiryDate2="30/11/2021";
			...
			public boolean checkStockMovementReports() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
			{
				...
				String expRow1List = "[BR COGS ITEM, 36.00, 20.00, 60.00, 51.50, 34.00, 28.75, 62.00, 42.75, 0.69, , , ]";
				...
				String actRow3List = reportsRow3ListArray.toString();
				String expRow3List = "[STD RATE COGS ITEM, 36.00, 20.00, 96.00, 344.50, 36.00, 595.50, 96.00, 960.00, 10.00, , , ]";
				...
				String actRow4List = reportsRow4ListArray.toString();
				String expRow4List = "[WA COGS ITEM, 24.00, 84.00, 42.00, 405.11, 23.00, 170.45, 43.00, 318.66, 7.41, , , ]";
			...
			public boolean checkStockMovementReportsWithStockMovementByWarehouseAndIncludeServiceTypeItemOptions() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
			{
		       //Thread.sleep(2000);
				...
				String actRow2List = reportsRow2ListArray.toString();
				String expRow2List = "[BR COGS ITEM, 36.00, 20.00, 48.00, 41.50, 22.00, 18.75, 62.00, 42.75, 0.69, , , ]";
				...
				String actRow3List = reportsRow3ListArray.toString();
				String expRow3List = "[FIFO COGS ITEM, 36.00, 20.00, 48.00, 41.50, 15.00, 11.25, 69.00, 50.25, 0.73, , , ]";
				...
				String actRow4List = reportsRow4ListArray.toString();
				String expRow4List = "[STD RATE COGS ITEM, 36.00, 20.00, 84.00, 224.50, 24.00, 27.67, 96.00, 216.83, 2.26, , , ]";
				...
				String actRow5List = reportsRow5ListArray.toString();
				String expRow5List = "[WA COGS ITEM, 24.00, 84.00, 32.00, 331.00, 13.00, 96.34, 43.00, 318.66, 7.41, , , ]";
				...
				String actRow6List = reportsRow6ListArray.toString();
				String expRow6List = "[Sub Total, 132.00, 144.00, 212.00, 638.50, 74.00, 154.01, 270.00, 628.49, 11.09, , , ]";
				...
				String actRow8List = reportsRow8ListArray.toString();
				String expRow8List = "[BR COGS ITEM, , , 12.00, 10.00, 12.00, 10.00, , , , , , ]";
				...
				String actRow10List = reportsRow10ListArray.toString();
				String expRow10List = "[STD RATE COGS ITEM, , , 12.00, 120.00, 12.00, 120.00, , , , , , ]";
				...
				String actRow11List = reportsRow11ListArray.toString();
				String expRow11List = "[WA COGS ITEM, , , 10.00, 74.11, 10.00, 74.11, , , , , , ]";
	...
	public boolean checkStockValuationReportBackTrackOption() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		...
		for(int i=0; i<backTrackVouchersColumnsCount; i++)
		{
			...
			if (data.equalsIgnoreCase("NDT57:SU//TEXT2DUB")) 
			{
				getAction().doubleClick(backTrackItemDetailsVouchersTableList.get(i)).build().perform();
			}
		}
	...
	public boolean checkStockReportbyTagReports() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		...
		String actRow2List = reportsRow2ListArray.toString();
		String expRow2List = "[FIFO COGS ITEM, FIFO COGS ITEM, 69.00, 0.82, 56.50, , , , , , , 69.00, 0.73, 50.25, , , , , , , , , ]";
		...
		String actRow5List = reportsRow5ListArray.toString();
		String expRow5List = "[Grand Total, , 270.00, 18.85, 1,372.91, , , , , , , 270.00, 11.09, 628.49, , , , , , , , , ]";
	...
	*/	
	...
	@FindBy(xpath="//*[@id='navigation_menu']/li[3]/ul/li[3]/ul/li[12]")
	...
	public boolean checkStockAnalysisByBatchReportWithStockTypeGoodBatches() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		...
		String actRow4List = reportsByWarehouseRow4ListArray.toString();
		String expRow4List = "[Grand Total, 50.00, 2.17, 32.75]";
		...
		String actRow5List = reportsByWarehouseRow5ListArray.toString();
		String expRow5List = "[Grand Total, 86.00, 2.94, 62.25]";
		...
		if(actReportTable&&expReportTable/*actRow1List.equalsIgnoreCase(expRow1List) && actRow2List.equalsIgnoreCase(expRow2List) && actRow3List.equalsIgnoreCase(expRow3List)
			&& actRow4List.equalsIgnoreCase(expRow4List) /*&& actRow5List.equalsIgnoreCase(expRow5List) && actRow6List.equalsIgnoreCase(expRow6List)*/)
		{
			return true;
		}
	...
	public boolean checkStockAnalysisByRmaReports() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		...
		String expPage4List = "[37, Ex Rma Update3, 1.00, 10.00, 10.00, 38, Ex Rma Update4, 1.00, 10.00, 10.00, 39, Ex Rma Update5, 1.00, 10.00, 10.00, 40, Ex Rma Update6, 1.00, 10.00, 10.00, 41, Ex Rma Update7, 1.00, 10.00, 10.00, 42, Ex Rma Update8, 1.00, 10.00, 10.00, 43, Ex Rma Update9, 1.00, 10.00, 10.00, 44, Grand Total, 43.00, 380.00, 380.00]";
	...
	//@FindBy(xpath="//*[@id='navigation_menu']/li[3]/ul/li[3]/ul/li[14]")
	...
	@FindBy(xpath="//*[@id='621']/span[contains(text(),' Stock ageing analysis ')]")
	private static WebElement stockAgeingAnalysisMenu;
	
	
	@FindBy(xpath="//*[@id='582']/span[contains(text(),'Ageing Analysis')]")
	...
	@FindBy(xpath="//*[@id='navigation_menu']/li[3]/ul/li[3]/ul/li[16]/ul/li[3]")
...
/*	@FindBy (xpath="(//div[@id='dvReportDetails']/div/table/tbody)[1]/tr/td")
	...
	*/
	...
	public boolean checkAgeingAnalysisByRMAReport() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		...
		String actPage1List = reportPage1ListArray.toString();
		String expPage1List = "[1, WA COGS ITEM WA COGS ITEM, 2, Ex Rma Update, 1.00, 7.41, 1.00, 7.41, , , , , , , , , , , , , , , 3, Ex Rma Update1, 1.00, 7.41, 1.00, 7.41, , , , , , , , , , , , , , , 4, Ex Rma Update2, 1.00, 7.41, 1.00, 7.41, , , , , , , , , , , , , , , 5, Ex Rma Update3, 1.00, 7.41, 1.00, 7.41, , , , , , , , , , , , , , , 6, Ex Rma Update4, 1.00, 7.41, 1.00, 7.41, , , , , , , , , , , , , , , 7, Ex Rma Update5, 1.00, 7.41, 1.00, 7.41, , , , , , , , , , , , , , , 8, Ex Rma Update6, 1.00, 7.41, 1.00, 7.41, , , , , , , , , , , , , , , 9, Ex Rma Update7, 1.00, 7.41, 1.00, 7.41, , , , , , , , , , , , , , , 10, Ex Rma Update8, 1.00, 7.41, 1.00, 7.41, , , , , , , , , , , , , , , 11, Ex Rma Update9, 1.00, 7.41, 1.00, 7.41, , , , , , , , , , , , , , , 12, RMA#R1OSV11, 1.00, 7.41, , , , , , , , , , , , , , , 1.00, 7.41]";
		...
		String actPage2List = reportPage2ListArray.toString();
		String expPage2List = "[13, RMA#R1OSV12, 1.00, 7.41, , , , , , , , , , , , , , , 1.00, 7.41, 14, RMA#R1PVVAT1, 1.00, 7.41, 1.00, 7.41, , , , , , , , , , , , , , , 15, RMA#R1PVVAT10, 1.00, 7.41, 1.00, 7.41, , , , , , , , , , , , , , , 16, RMA#R1PVVAT11, 1.00, 7.41, 1.00, 7.41, , , , , , , , , , , , , , , 17, RMA#R1PVVAT12, 1.00, 7.41, 1.00, 7.41, , , , , , , , , , , , , , , 18, RMA#R1PVVAT2, 1.00, 7.41, 1.00, 7.41, , , , , , , , , , , , , , , 19, RMA#R1PVVAT3, 1.00, 7.41, 1.00, 7.41, , , , , , , , , , , , , , , 20, RMA#R1PVVAT4, 1.00, 7.41, 1.00, 7.41, , , , , , , , , , , , , , , 21, RMA#R1PVVAT5, 1.00, 7.41, 1.00, 7.41, , , , , , , , , , , , , , , 22, RMA#R1PVVAT6, 1.00, 7.41, 1.00, 7.41, , , , , , , , , , , , , , , 23, RMA#R1PVVAT7, 1.00, 7.41, 1.00, 7.41, , , , , , , , , , , , , , , 24, RMA#R1PVVAT8, 1.00, 7.41, 1.00, 7.41, , , , , , , , , , , , , , ]";
	...
	@FindBy (xpath="//*[@id='FilterFields_586_0']/ul[4]/li[1]/div/label/span")
	...
	public boolean checkStockTransferRegisterReport() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		...
		String actRow7List = reportsRow7ListArray.toString();
		String expRow7List = "[STD RATE COGS ITEM STD RATE COGS ITEM]";
	...
	public boolean checkStockReportbyTagReportsWithUserForItemRestriction() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		...
		String actRow1List = reportsRow1ListArray.toString();
		String expRow1List = "[FIFO COGS ITEM, FIFO COGS ITEM, 69.00, 0.75, 51.50, , , , , , , 69.00, 0.73, 50.25, , , , , , , , , ]";
		...
		String actRow3List = reportsRow3ListArray.toString();
		String expRow3List = "[Grand Total, , 131.00, 1.44, 94.25, , , , , , , 131.00, 1.42, 93.00, , , , , , , , , ]";
