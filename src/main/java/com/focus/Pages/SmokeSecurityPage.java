...
public class SmokeSecurityPage extends BaseEngine
{
	...
	public static WebElement  homeCompanyMenu; 
	...
	*/
	...
	public static WebElement networkPolicy;
		...
		public static WebElement passwordPolicyList;
			...
			public static WebElement passwordPolicyNameCheck;
			
			@FindBy (xpath="//html[1]/body[1]/section[1]/div[2]/div[1]/section[1]/div[1]/div[2]/div[1]/div[1]/ul[1]/li[4]")
			public static WebElement passwordPolicyNameToDelete;
...
public static String checkValidationMessage(String ExpMessage) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
{
        try
        {
                ...
                if(validationMessage.getText().isEmpty()==false)
                {
	 ...
	 private static String xlSheetName = "SmokeUsers";
   ...
   public static boolean checkCloseAlertInAlertClickOnOkBtn() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
   {
	     ...
	     boolean actDisplay = labelDashboard.isDisplayed() &&
 ...
 public static boolean checkPasswordPolicy() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
 {
	...
	Thread.sleep(2000);
		...
		String exppasswordPolicyTitle = "Password policy";	
	...
	public static boolean checkPasswordPolicyLists() throws EncryptedDocumentException, InvalidFormatException, IOException
	{
        ...
        String exppasswordPolicyNameInList ="[Simple Policy, Numeric, Portal, Test]";
	...
	public static boolean checkGetTheTestPasswordPolicy() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	{
		...
		Thread.sleep(2000);
	     ...
	     String exppolicyName = "Test";
			        
	     String actpasswordLength=passwordLength.getAttribute("value");
	     String exppasswordLength = "2";
		 ...
		 String exppasswordComplexity = "Simple";
	...
	public static boolean checkAlertOnDeletePasswordPolicy() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		...
		getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(policyName));
		policyName.sendKeys("PolicytoDelete");
				
		getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(passwordLength));
		passwordLength.sendKeys("8");		
		...
		for (int i = 0; i < passwordListCount; i++) 
		{
			...
			if (data.equalsIgnoreCase("PolicytoDelete")) 
			{
				passwordList.get(i).click();
				break;
			}
...
public static boolean checkCancelBtnInPasswordPolicy() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
{
   ...
   //Home Menu Security Menu Create Profile Starts
	...
	@FindBy(xpath="//ul[@id='Profilemenu']/li[1]/ul/li[3]/a/span")
...
@FindBy(xpath="//*[@id='Profilemenu']/li[1]/ul/li[3]/ul/li[3]/ul/li/a/span")
...
@FindBy(xpath="//*[@id='Profilemenu']/li[1]/ul/li[3]/ul/li[3]/a/span")
...
@FindBy(xpath="(//button[@class='Fbutton'][contains(text(),'Ok')])[2]")
public static WebElement loadPopupOkBtn;

@FindBy(xpath="(//button[@class='Fbutton'][contains(text(),'Cancel')])[2]")
...
public boolean  checkNoOption() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
{
	...
	public static WebElement gridFifthRowMasterToClick;
	 ...
	 @FindBy(xpath="//div[@class='Fcheckbox']//span[text()='Edit']/parent::label/input")
	 ...
	 @FindBy(xpath="//div[@class='Fcheckbox']//span[text()='Always suspend on saving']/parent::label/input")
	 ...
	 @FindBy(xpath="//div[@class='Fcheckbox']//span[text()='Hide Menu']/parent::label/input")
	 ...
	 //Home 
			 ...
			 @FindBy(xpath="//div[@id='myNavbar']/ul/li/span")
...
// Create Profile Starts here
 ...
 try
	...
	createProfile.click();
	 ...
	 createProfileProfileNameCombo.sendKeys("TestProfileAllOptions");
        
	
	
	getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(createProfileSaveIcon));
	
	int count = createProfileHomeToolButtons.size();
	...
	if (actButtons.equalsIgnoreCase(expButtons)) 
 	{
 ...
 catch (Exception e)
	{
	 	...
	 	excelReader.setCellData(xlfile, xlSheetName, 5, 10, exception);
 ...
 {	 
	 ...
	 String expMessage1 = "Please provide profile name";
	 ...
	 createProfileProfileNameCombo.sendKeys("TestProfileSubMenus");
	 
	 getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(createProfileSaveIcon));
	 createProfileSaveIcon.click();
	 
	 String expMessage2 = "Provide some Permissions and Save";
	...
	System.out.println(actHomeMenus);
	...
	String expFinancialMenus = "";
	
	System.out.println(actFinancialMenus);
	...
	String expInventoryMenus = " ";
	
	System.out.println(actInventoryMenus);
	...
	String actFixedAssetsMenus = fixedAssetsTransactionExpandBtn.getText();
	
	String expFixedAssetsMenus = "";
	
	System.out.println(actFixedAssetsMenus);
	...
	String expProductionMenus = "";
	
	System.out.println(actProductionMenus);
	...
	String expPointOfSaleMenus = "";
	
	System.out.println(actPointOfSaleMenus);
	...
	String expQualityControlMenus = "";
	
	System.out.println(actQualityControlMenus);
	...
	if (actMessage1.equalsIgnoreCase(expMessage1) && actMessage2.equalsIgnoreCase(expMessage2) && 
	     ...
	     actInventoryMenus.equalsIgnoreCase(expInventoryMenus) && actFixedAssetsMenus.equalsIgnoreCase(expFixedAssetsMenus) && actProductionMenus.equalsIgnoreCase(expProductionMenus) &&
 ...
 catch (Exception e)
	{
	 	...
	 	excelReader.setCellData(xlfile, xlSheetName, 7, 10, exception);
 ...
 try
 ...
 catch (Exception e)
	{
	 	...
	 	excelReader.setCellData(xlfile, xlSheetName, 20, 10, exception);
 ...
 try
 ...
 catch (Exception e)
	{
	 	...
	 	excelReader.setCellData(xlfile, xlSheetName, 23, 10, exception);
 ...
 try
 ...
 catch (Exception e)
	{
	 	...
	 	excelReader.setCellData(xlfile, xlSheetName, 30, 10, exception);
...
*/	
 ...
 try
 ...
 catch (Exception e)
	{
 	...
 	@FindBy(xpath="//ul[@id='restrictionsDiv']/li/div/label/span")
 ...
 try
 {
 ...
 catch (Exception e)
	{
	 	...
	 	excelReader.setCellData(xlfile, xlSheetName, 51, 10, exception);
 ...
 try
 ...
 catch (Exception e)
	{
	 	...
	 	excelReader.setCellData(xlfile, xlSheetName, 53, 10, exception);
 ...
 try
	 ...
	 */
	 ...
	 for(int i=0;i<restrictionTabChkBoxListCount;i++)
	 {
		 ...
		 if(unselected==false)
		 {
			 String Select = restrictionTabChkBoxNameList.get(i).getText();
 ...
 try	
 {
 ...
 catch (Exception e)
	{
	 	...
	 	excelReader.setCellData(xlfile, xlSheetName, 65, 10, exception);
 ...
 try
 ...
 catch (Exception e)
	{
	 	...
	 	excelReader.setCellData(xlfile, xlSheetName, 67, 10, exception);
 ...
 public boolean checkCreateProfileLoadFromAllProfileAndValidatePurchasesVouchers() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
 {
	...
	String expMessage="Please Provide New Profile Name";
	...
	for (int i = 0; i < profilesCount; i++) 
	{
		...
		if (actloadProfile.equalsIgnoreCase("All Profile ST"))
		{
 ...
 public boolean checkCreateProfileSavingValidatingAndDeletingLoadedProfile() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
 {
	 ...
	 {
		 String actProfileName=createProfileProfileNameList.get(i).getText();
	 	 if (actProfileName.equalsIgnoreCase("TEST"))
	 	 {
	 		createProfileProfileNameList.get(i).click();
...
// Restriction for trees Tab
 ...
 @FindBy(xpath="//div[@class='Fcheckbox']/label/input[@id='0']")
 public static WebElement restrictionForTreesTabDefaultChkBox;
 
 // AI Rights
@FindBy(xpath="//input[@id='EnableVUI']")
public static WebElement AIRightsEnableVUIChkBox;

@FindBy(xpath="//input[@id='EnableAI']")
 ...
 public boolean checkCreateRolePageWithAllOptions() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
{
	  ...
	  String expAssignedProfilesOptions = "true";
	  ...
	  if (actAssignedProfilesOptions.equalsIgnoreCase(expAssignedProfilesOptions)) 
		{
		  	return true;
		} 
		else 
  ...
  {	 
   ...
   if (actMessage.equalsIgnoreCase(expMessage)) 
   {
 ...
 catch (Exception e)
	{
	 	...
	 	excelReader.setCellData(xlfile, xlSheetName, 93, 10, exception);
 ...
 try
	{
		...
		String expPasswordPolicyList = excelReader.getCellData(xlSheetName, 94, 7);
 ...
 catch (Exception e)
	{
	 	...
	 	excelReader.setCellData(xlfile, xlSheetName, 94, 10, exception);
...
catch (Exception e)
{
 	...
 	excelReader.setCellData(xlfile, xlSheetName, 95, 10, exception);
...
catch (Exception e)
{
 	...
 	excelReader.setCellData(xlfile, xlSheetName, 96, 10, exception);
...
public boolean  checkClickOnRightArrowIconWitSelectProfile() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
{
 ...
 try
 {
	 ...
	 Set<String> AssignedProfilesList=new HashSet<String>();
	  ...
	  String expavailableProfilesArea = excelReader.getCellData(xlSheetName, 98, 7);
...
catch (Exception e)
{
 	...
 	excelReader.setCellData(xlfile, xlSheetName, 97, 10, exception);
...
public boolean  checkClickOnLeftArrowIconWitSelectProfile() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
{
  ...
  try
  {
	...
	catch (Exception e)
	{
	 	...
	 	excelReader.setCellData(xlfile, xlSheetName, 99, 10, exception);
...
catch (Exception e)
{
 	...
 	excelReader.setCellData(xlfile, xlSheetName, 101, 10, exception);
...
catch (Exception e)
{
 	...
 	excelReader.setCellData(xlfile, xlSheetName, 102, 10, exception);
...
{
 	String exception = e.getMessage();
 	excelReader.setCellData(xlfile, xlSheetName, 240, 10, exception);
	return false;
}   
}
...
try
{
	...
	{
	 	String exception = e.getMessage();
	 	excelReader.setCellData(xlfile, xlSheetName, 247, 10, exception);
		return false;
	}
}
...
try
   ...
   else 
   {
	...
	{
	 	String exception = e.getMessage();
	 	excelReader.setCellData(xlfile, xlSheetName, 248, 10, exception);
		return false;
	}
}
...
try
	...
	{
	 	String exception = e.getMessage();
	 	excelReader.setCellData(xlfile, xlSheetName, 249, 10, exception);
		return false;
	}
}
...
try
	...
	{
	 	String exception = e.getMessage();
	 	excelReader.setCellData(xlfile, xlSheetName, 251, 10, exception);
...
public boolean checInputMandatoryFieldsInCreateUser() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
{
	...
	Thread.sleep(5000);
	 ...
	 getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(createUserLoginNameTxt));
	 createUserLoginNameTxt.click();
	 createUserLoginNameTxt.sendKeys("Test");
 ...
 public static boolean checkCreateUserWithRestrictionsForAccount() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
 {
	 ...
	 getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(createUserLoginNameTxt));
	 createUserLoginNameTxt.click();
	 createUserLoginNameTxt.sendKeys("UserAccountRestrictions");
	 ...
	 getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(createUserPasswordTxt));
	 createUserPasswordTxt.sendKeys("456789");

	 getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(createUserConfirmPasswordTxt));
	 createUserConfirmPasswordTxt.sendKeys("456789");
	 	
	 getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(createUserNameTxt));
	 createUserNameTxt.sendKeys("AccountRestriction");
	 	
	 getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(createUserLoginAbbrivationTxt));
	 createUserLoginAbbrivationTxt.sendKeys("UAR");
	 ...
	 user.selectByVisibleText("Customer");
		...
		createUserEmailTxt.click();
		createUserEmailTxt.clear();
		createUserEmailTxt.sendKeys("test@focussoftnet.com");
...
try
    ...
    for(int i=0;i<4;i++)
	 {
    	boolean actValidationMessage=validationMessage.getText().isEmpty();
...
{ 
	 ...
	 for (int i = 0; i < actUsersCount; i++) 
	 {
		 ...
		 if (actUser.equalsIgnoreCase("Test")) 
		 {
			 createUserSavedUsersList.get(i).click();
	 ...
	 Thread.sleep(2000);
			 ...
			 getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(createUserPasswordTxt));
			 createUserPasswordTxt.clear();
			 createUserPasswordTxt.sendKeys("54321");
			 
			 getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(createUserConfirmPasswordTxt));
			 createUserConfirmPasswordTxt.clear();
			 createUserConfirmPasswordTxt.sendKeys("54321");
...
try
	...
	catch (Exception e)
	{
	 	...
	 	excelReader.setCellData(xlfile, xlSheetName, 292, 10, exception);
...
public boolean checkLogoutAndLoginWithUpdatedUserWithPreviousPassword() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
{
      ...
      String expMessage = "Invalid Password";
...
public static boolean checkLedgerForRestrictedAccountsInUserThroughRole() throws InterruptedException
{
	Thread.sleep(2000);
	...
	getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(financialsMenu));
	 ...
	 accountSearchTextArea.sendKeys("Vendor");
	 ...
	 Thread.sleep(2000);
	 accountSearchTextArea.sendKeys("Customer");
	 accountSearchTextArea.sendKeys(Keys.ENTER);
...
public static boolean checkLogoutAndLoginWithCreatedRestrictedUser() throws InterruptedException
{
	  getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(userNameDisplay));
	  userNameDisplay.click();
	  Thread.sleep(2000);
	  ...
	  getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(username));
	  username.sendKeys("UserAccountRestrictions");
	  getAction().moveToElement(username).sendKeys(Keys.TAB).perform();
	  Thread.sleep(2000);
      ...
      userNameDisplay.click();
  	  ...
  	  String actUserInfo = userNameDisplay.getText();
  	  String expUserInfo = "UserAccountRestrictions";
...
public static boolean checkLedgerForRestrictedAccountThroughUser() throws InterruptedException
{
	Thread.sleep(2000);
	getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(financialsMenu));
	 financialsMenu.click();
...
public boolean checkDeletingUpdatedUser() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
{
	...
	public boolean CheckSavingPassWordPolicyOfNumericTypeandSimplePolicy() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		...
		catch (Exception e)
		{
			...
			excelReader.setCellData(xlfile, xlSheetName, 314, 10, exception);
	...
	public boolean  checkSavingUserWithRoleST() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	{
		...
		catch(Exception e)
		{
			...
			excelReader.setCellData(xlfile, xlSheetName, 318, 10, exception);
	...
	public boolean  checkSavingUserWithRoleSTRestriction() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	{
		...
		catch(Exception e)
		{
			...
			excelReader.setCellData(xlfile, xlSheetName, 347, 10, exception);
