	...
	//Currency Menu
		...
		public boolean checkExportingSellerPriceBook() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException, AWTException
		{
			...
			System.err.println("No of tabs : "+actOpenWindowsCount);
		 	...
		 	Workbook Exportedfile= new XSSFWorkbook(getBaseDir()+"\\autoIt\\ExportFiles\\TestSmokeSellingRates.xlsx");
		...
		private static WebElement sheetHeading;
		...
		private static WebElement sheetP;
		...
		public boolean checkImportingSellerPriceBook() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
		{
			...
			String expPriceBookRow1 ="[1, ITEMS GROUP, , AMERICA, "+presentDate+", "+endDate+", , Indian Rupees, 0, 0, , 300.000000, 200.000000, 100.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, , , , Authorized, ]";
			...
			String expPriceBookRow2 ="[2, BR COGS ITEM, , AMERICA, "+presentDate+", "+endDate+", , Indian Rupees, 0, 0, Pcs, 500.000000, 400.000000, 300.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, , , , Authorized, ]";
...
////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		@FindBy(xpath="//*[@id='myNavbar']/div/div[9]/div[1]")
		...
		@FindBy(xpath="//*[@class='icon-close icon-font6']")
		...
		public boolean checkSavedSellerPriceBookatVoucherSalesInvoice() throws InterruptedException
		{
			...
			getAction().moveToElement(select1stRow_1stColumn).build().perform();
	...
	public void checkAddingExtraFieldinPurchaseVoucher() throws InterruptedException
	{
			...
			getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(PV_settingsCloseBtn));
			PV_settingsCloseBtn.click();
			Thread.sleep(2000);
