...
*/	
	...
	public static WebElement enter_Bin2;

	@FindBy(xpath="//*[@id='id_body_85']")
	public static WebElement enter_Bin1;
	...
	public boolean checkSavingStockTransferVoucher() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		...
		getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(enter_Bin1));
		enter_Bin1.sendKeys(Keys.TAB);
...
*/	
	...
	private static List<WebElement> batchPopupNameList;

	@FindBy (xpath="//*[@id='Id_MRPBatch_Grid_body']/tr/td[1]")
	private static List<WebElement> batchPopupIndexList;
...
*/	
		...
		catch (Exception e) 
		{
			...
			getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(enter_Bin2));
			enter_Bin2.sendKeys(Keys.SPACE);
...
*/	
	...
	public boolean checkDeleteOptionInStockTransferFromHomePage() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		...
		String expMessage = "VoucherNo - 3: Voucher deleted Successfully";
		String actMessage = checkValidationMessage(expMessage);
