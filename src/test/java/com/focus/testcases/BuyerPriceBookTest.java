...
/////////////////////////	Footer fields validation//////////////////////////////////////////
	...
	// @Test(priority=187)
	 public void checkExportingBuyerPriceBookExcel() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException, AWTException
	 {
		 BPB=new BuyerPriceBookPage(getDriver());
		 Assert.assertEquals(BPB.checkExportingBuyerPriceBookExcel(), true);
	 }
	...
	// @Test(priority=188)
	 public void checkAddingExtraRowinExportedFile() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException, AWTException
	 {
		 BPB=new BuyerPriceBookPage(getDriver());
		 Assert.assertEquals(BPB.checkAddingExtraRowinExportedFile(), true);
	 }
	 ...
	 //@Test(priority=189)
	 public void checkImportingAppendExcelBuyerPriceBook() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException, AWTException
	 {
		 BPB=new BuyerPriceBookPage(getDriver());
		 Assert.assertEquals(BPB.checkImportingAppendExcelBuyerPriceBook(), true);
	 }
