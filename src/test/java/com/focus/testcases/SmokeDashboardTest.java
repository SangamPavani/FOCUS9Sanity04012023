...
public class SmokeDashboardTest extends BaseEngine 
{
	...
	// @Test(priority=204)
	 public void checkOtherDashletOptionsinDashboard() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	 {
		 HPDP=new SmokeDashboardPage(getDriver());
		 Assert.assertEquals(SmokeDashboardPage.checkOtherDashletOptionsinDashboard(), true);
	 }
