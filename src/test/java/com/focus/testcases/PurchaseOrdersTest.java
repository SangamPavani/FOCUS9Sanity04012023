...
public class PurchaseOrdersTest extends BaseEngine
{
	PurchaseOrdersPage PO;
	 ...
	 @Test(priority=267)
	 public void checkSuspendingMaterialRequisitionVoucher2FromEntryPage() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException, AWTException
	 {
		 PO=new PurchaseOrdersPage(getDriver());
		 Assert.assertEquals(PO.checkSuspendingMaterialRequisitionVoucher2FromEntryPage(), true);
	 }
