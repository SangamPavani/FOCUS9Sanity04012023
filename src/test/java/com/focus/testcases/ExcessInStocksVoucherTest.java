...
public class ExcessInStocksVoucherTest extends BaseEngine
{
	...
	@Test(priority=286)
	public void checkDeletingExcessesInStockVoucher3FromEntryPage() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException, AWTException
	{
		EIS=new ExcessInStocksVoucherPage(getDriver());
		Assert.assertEquals(EIS.checkDeletingExcessesInStockVoucher3FromEntryPage(), true);
	}
