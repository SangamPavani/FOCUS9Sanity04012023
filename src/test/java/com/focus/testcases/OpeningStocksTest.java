...
public class OpeningStocksTest extends BaseEngine
{
	...
	// @Test(priority=102)
		 public void checkOpenNetworkPolicy() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException, AWTException
		 {
			 OSP=new OpeningStocksPage(getDriver());
			 Assert.assertEquals(OSP.checkOpenNetworkPolicy(), true);
		 }
