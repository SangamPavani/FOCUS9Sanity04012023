...
public class MasterPreloadTest extends BaseEngine 
{
	...
	@Test(priority=3006)
	public void CheckSavingPurchaseVoucherVATWithStockItemAndSTDRateItem() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		MPP=new MasterPreloadPage(getDriver());
		Assert.assertEquals(MPP.CheckSavingPurchaseVoucherVATWithStockItemAndSTDRateItem(), true);
	}
	...
	@Test(priority=3008)
	public void CheckEditingPurchaseVoucherVAT1WithStockItemAndSTDRateItem() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		MPP=new MasterPreloadPage(getDriver());
		Assert.assertEquals(MPP.CheckEditingPurchaseVoucherVAT1WithStockItemAndSTDRateItem(), true);
	}
	
	@Test(priority=3009)
	public void checkSavedPVVATAfterEditingVoucher() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		MPP=new MasterPreloadPage(getDriver());
		Assert.assertEquals(MPP.checkSavedPVVATAfterEditingVoucher(), true);
	}
